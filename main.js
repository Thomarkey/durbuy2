var cal = {
    ...
    show : function (el) {
      ...
      // (C2) DRAW EVENT FORM
      var tForm = "<h1>Who is going?</h1>";
      tForm += "<div id='evt-date'>" + cal.sDay + " " + cal.mName[cal.sMth] + " " + cal.sYear + "</div>";
    //   tForm += "<div name='evt-people'><input type='checkbox' value='naam1'>naam1 </br> </input><input type='checkbox' value='naam2'>naam2 </br></input><input type='checkbox'>naam3 </br></input><input type='checkbox'>naam4 </br></input></div>";
    ...
    //   cal.data[cal.sDay] = document.querySelector('input[type="checkbox"]:checked').value;
